...
*   I wanted to also add in a way to make sure the player doesn't input an
*   invalid value, say a letter for example, but I couldn't figure out how to
*   do that.  I did, however, add in code that checks to make sure the cell
